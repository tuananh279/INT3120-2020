...
export default class AcocommodationScreen extends Component {
  constructor(props) {
    super(props);
  ...
  listenForItems(itemRef) {
    var items = [];
    this.itemRef.ref('accomodation').on('child_added', (dataSnapshot) => {
      items.push({
  ...
  showDB() {
    this.itemRef.ref('accomodation').child(this.state.text).on('value', function(snapshot){
      alert(snapshot.val())
    });
