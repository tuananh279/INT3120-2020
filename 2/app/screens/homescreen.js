    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        ...
        <TouchableOpacity
          activeOpacity={0.5}
          onPress={() => {
            navigation.navigate('Acocommodation');
          }}>
          <View style={styles.item}>
            <View style={{flex: 1}}>
              <ImageBackground
            ...
            <View style={{flex: 2}}>
              ...
              <Text style={{color: '#9e9e9e', marginBottom: 5}}>Chỗ ở</Text>
              <Text>
                <FontAwesome5 name={'star'} color={'#e0e0e0'} light />
                <FontAwesome5 name={'star'} color={'#e0e0e0'} light />
                <FontAwesome5 name={'star'} color={'#e0e0e0'} light />
        ...
        <TouchableOpacity
          ...
          <View style={styles.item}>
            ...
            <View style={{flex: 2}}>
              ...
              <Text style={{color: '#9e9e9e', marginBottom: 5}}>Mua sắm</Text>
              <Text>
                <FontAwesome5 name={'star'} color={'#e0e0e0'} light />
                <FontAwesome5 name={'star'} color={'#e0e0e0'} light />
                <FontAwesome5 name={'star'} color={'#e0e0e0'} light />
        ...
        <TouchableOpacity
          ...
          <View style={styles.item}>
            ...
            <View style={{flex: 2}}>
              ...
              <Text style={{color: '#9e9e9e', marginBottom: 5}}>Gia đình</Text>
              <Text>
                <FontAwesome5 name={'star'} color={'#e0e0e0'} light />
                <FontAwesome5 name={'star'} color={'#e0e0e0'} light />
                <FontAwesome5 name={'star'} color={'#e0e0e0'} light />
        ...
        <TouchableOpacity
          ...
          <View style={styles.item}>
            ...
            <View style={{flex: 2}}>
              ...
              <Text style={{color: '#9e9e9e', marginBottom: 5}}>Hẹn hò</Text>
              <Text>
                <FontAwesome5 name={'star'} color={'#e0e0e0'} light />
                <FontAwesome5 name={'star'} color={'#e0e0e0'} light />
                <FontAwesome5 name={'star'} color={'#e0e0e0'} light />
        ...
        <TouchableOpacity
          ...
          <View style={styles.item}>
            ...
            <View style={{flex: 2}}>
              ...
              <Text style={{color: '#9e9e9e', marginBottom: 5}}>Khám bệnh</Text>
              <Text>
                <FontAwesome5 name={'star'} color={'#e0e0e0'} light />
                <FontAwesome5 name={'star'} color={'#e0e0e0'} light />
                <FontAwesome5 name={'star'} color={'#e0e0e0'} light />
