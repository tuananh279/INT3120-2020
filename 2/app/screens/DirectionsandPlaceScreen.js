...
export default class DirectionsandPlaceScreen extends Component {
  constructor(props) {
    super(props);
  ...
  listenForItems(itemRef) {
    var items = [];
    this.itemRef.ref('directions').on('child_added', (dataSnapshot) => {
      items.push({
  ...
  showDB() {
    this.itemRef.ref('directions').child(this.state.text).on('value', function(snapshot){
      alert(snapshot.val())
    });
